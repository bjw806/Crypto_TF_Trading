...
model_path = '../model/weights-improvement/weights-improvement-11-0.99.h5' ##/model.h5
predict_file = '../test_data/ccxt_binance_test_2g_5m_15m.jpg'
...
#   0      1     2    3     4       5
def ccxt_graph():
    ohlcv_15m = binance.fetch_ohlcv('BTC/USDT', timeframe='15m', limit=24)
    ohlcv_15m_for_ma = binance.fetch_ohlcv('BTC/USDT', timeframe='15m', limit=124)
    ohlcv_1h = binance.fetch_ohlcv('BTC/USDT', timeframe='5m', limit=12)
    ohlcv_1h_for_ma = binance.fetch_ohlcv('BTC/USDT', timeframe='5m', limit=112)
    ...
    plt.savefig('../test_data/ccxt_binance_test_2g_5m_15m.jpg', bbox_inches='tight')  # uuid.uuid4()
    # plt.show()
    plt.cla()  # 좌표축을 지운다.
